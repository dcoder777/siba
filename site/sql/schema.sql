...
CREATE TABLE IF NOT EXISTS applications (
    ...
    caste_cert VARCHAR(255),
    father_photo VARCHAR(255),
    mother_photo VARCHAR(255),
    father_aadhaar_no VARCHAR(20),
    father_aadhaar VARCHAR(255),
    mother_aadhaar_no VARCHAR(20),
    mother_aadhaar VARCHAR(255),
    father_voter_no VARCHAR(30),
    father_voter VARCHAR(255),
    mother_voter_no VARCHAR(30),
    mother_voter VARCHAR(255),
    disability_cert VARCHAR(255),
