    ...
    <main class="admin-main stack" style="padding:1.5rem;">
        <section class="hero-banner" style="margin-bottom:1rem;">
            <div class="toolbar">
                <div class="stack" style="gap:.55rem">
                    ...
                    <h1>Payroll</h1>
                    <p>Employee salary management and monthly payroll processing.</p>
                </div>
            </div>
        </section>
        ...
        <div style="display:flex;align-items:center;justify-content:center;min-height:50vh;">
            <div style="text-align:center;max-width:480px;">
                ...
                <p style="color:#64748b;font-size:.95rem;line-height:1.6;margin-bottom:1.5rem;">Payroll module is under development. Salary structures, payroll generation, and payout tracking will be available here soon.</p>
