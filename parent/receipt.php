...
<div class="receipt">
    ...
    <div class="receipt-header">
        <div class="receipt-brand">
            <img src="<?= SITE_LOGO_URL ?>" alt="SIBA Public School" class="logo" onerror="this.style.display='none'">
            <div>
    ...
    <div class="receipt-body">
        ...
        <div class="no-print">
            <a class="btn btn-download" href="receipt.php?app_id=<?= (int) $appId ?>&download=1"><i class="fas fa-download"></i> Download PDF</a>
